...
spark:
	docker exec -it $$(docker ps -f name=spark-worker -q) spark-submit --packages org.apache.hadoop:hadoop-aws:3.3.4,org.apache.iceberg:iceberg-spark-runtime-3.5_2.12:1.4.2 /pyspark/tasks/staging/stg_clockify__time_entries.py